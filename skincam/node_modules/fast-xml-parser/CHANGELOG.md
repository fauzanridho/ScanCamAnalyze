<small>Note: If you find missing information about particular minor version, that version must have
...
- Fix: builder should set text node correctly when only textnode is present (#589) (
